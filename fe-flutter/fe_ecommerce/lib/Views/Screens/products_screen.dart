import 'package:fe_ecommerce/Views/Widgets/add_product_drawer.dart';
import 'package:fe_ecommerce/Views/Widgets/elev_button.dart';
import 'package:fe_ecommerce/Views/Widgets/product_container.dart';
...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero,()async {
      await Provider.of<ProductProvider>(context, listen: false).getProducts(0, null, null, GetTypes.PAGING);
