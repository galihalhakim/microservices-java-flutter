import 'package:fe_ecommerce/Models/product.dart';
...
class AddProductDrawer extends StatefulWidget {
  ...
  @override
  _AddProductDrawerState createState() => _AddProductDrawerState();
}
...
class _AddProductDrawerState extends State<AddProductDrawer> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      _editProduct = Provider.of<ProductProvider>(context, listen: false).productToEdit;
